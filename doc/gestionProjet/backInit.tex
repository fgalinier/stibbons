...
Lors du sprint 0, nous avons effectué une analyse des outils à notre disposition (Flex, Bison, etc) et de l'existant, le langage Logo et ses dérivés, et avons réalisé une estimation du temps de travail (cf. Figure~\ref{planning}) pour évaluer combien de sprints nous pourrions faire en tenant compte des autres activités parallèles (cours, examens, révisions, etc.).
\begin{figure}[h]
