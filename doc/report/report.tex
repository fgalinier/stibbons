...
\begin{abstract}
Le langage Stibbons est un langage de programmation multi-agents pour programmeurs débutants et avancés. Notre projet est réalisé en C++ et ses applications utilisent le framework Qt.
