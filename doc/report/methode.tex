...
Une fois ces fonctionnalités définies, nous avons priorisé celles-ci et établi le «~backlog~»~: la feuille de route de notre projet (cf. Table~\ref{bsp1}).
...
Lors de la réunion de début de sprint, les fonctionnalités à ajouter sont choisies et pour chacune d'entre elles une description du test à effectuer afin de la valider était ajoutée au backlog. Nous faisions également une estimation du nombre d'heures nécessaires à chacune des nouveautés.
...
Sur le backlog final (cf. Table~\ref{bsp5}), nous pouvons voir les ajouts effectués, le changement de statut des fonctionnalités réalisées, et le temps réel passé à les rendre utilisables.
