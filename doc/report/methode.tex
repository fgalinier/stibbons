...
Nous avons commencer le projet avec un sprint 0, au cours duquel nous avons défini l'univers du projet, et ses fonctionnalités (cf.~\ref{bsp1}).
{\tiny
...
Le backlog est composé de scénarios utilisateurs qui définissent les tâches à effectuer. Cela correspond a une courte description d'une fonctionnalité du programme. On leur attribut une priorité, et un test de validation.
